  ...
  en: {
    ...
    science: {
      ...
      literatureItems: [
        ...
        {
          title: 'Intensity or volume: the role of physical activity in longevity',
          year: '2025',
          url: 'https://academic.oup.com/eurjpc/article/32/1/10/7758152',
          dateAdded: '2026-03-01',
          summary: 'Research (observational). European Journal of Preventive Cardiology. Investigates how physical activity volume, intensity, duration, and fragmentation associate with all-cause and cardiovascular disease mortality in US adults.',
          categories: ['exercise', 'longevity'],
        },
        {
          title: 'MiRNAs shape mouse age-independent tissue adaptation to spaceflight via ECM and developmental pathways',
          year: '2026',
          url: 'https://www.nature.com/articles/s41467-026-68737-1',
          dateAdded: '2026-03-01',
          summary: 'Research (in vivo). Nature Communications. Demonstrates that miRNAs mediate age-independent multi-organ adaptations to spaceflight via ECM, DNA damage, and developmental pathways in mice.',
          categories: ['tsrna', 'brain'],
        },
        {
          title: 'Extracellular vesicles as mediators of metabolomic changes in response to PET microplastics',
          year: '2025',
          url: 'https://www.sciencedirect.com/science/article/pii/S0269749125014204',
          dateAdded: '2026-03-04',
          summary: 'Research. Environmental Pollution. Investigates how PET microplastic exposure alters metabolomic profiles through extracellular vesicle-mediated signaling.',
          categories: ['exposome', 'ev'],
        },
        {
          title: 'Poor Sleep Quality Is Associated With an Increased Risk of Running-Related Injuries: A Prospective Study of 339 Runners Over Six Months',
          year: '2025',
          url: 'https://pubmed.ncbi.nlm.nih.gov/41239840/',
          dateAdded: '2026-03-04',
          summary: 'Research (prospective). Scandinavian Journal of Medicine & Science in Sports. Demonstrates that poor sleep quality is associated with increased risk of running-related injuries in a six-month prospective study of 339 runners.',
          categories: ['exercise'],
        },
        {
          title: 'Altered sperm tsRNAs in aged male contribute to anxiety-like behavior in offspring',
          year: '2021',
          url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC8441364/#acel13466-sec-0009',
          dateAdded: '2026-03-04',
          summary: 'Research (in vivo). Aging Cell. Shows that altered tRNA-derived small RNAs in aged male sperm contribute to anxiety-like behavior in offspring.',
          categories: ['tsrna', 'brain'],
        },
        {
          title: 'Short-term diet intervention comprising of olive oil, vitamin D, and omega-3 fatty acids alters the small non-coding RNA (sncRNA) landscape of human sperm',
          year: '2025',
          url: 'https://www.nature.com/articles/s41598-024-83653-4',
          dateAdded: '2026-03-12',
          summary: 'Research (human). Scientific Reports. A 6-week dietary intervention with olive oil, vitamin D, and omega-3 fatty acids alters tRF, miRNA, and piRNA expression in human sperm, implicating sperm sncRNAs as epigenetic mediators of paternal nutrition.',
          categories: ['nutrition', 'tsrna'],
        },
        {
          ...
          dateAdded: '2026-03-12',
          summary: 'Research (in vivo). Nature. Infusing young cerebrospinal fluid into aged mice restores oligodendrogenesis and memory, identifying Fgf17 as a key rejuvenating factor that declines with aging.',
          categories: ['brain', 'longevity'],
        },
        {
          ...
          year: '2025',
          url: 'https://doi.org/10.1093/ageing/afag010',
          dateAdded: '2026-07-08',
          summary: 'Research (RCT). Age and Ageing. Investigates how a 17-week high-protein dietary intervention, with or without concurrent strength training, alters the plasma metabolome in older adults.',
          categories: ['nutrition', 'exercise', 'longevity'],
        },
        {
          title: 'Micro- and Nanoplastics Breach the Blood–Brain Barrier (BBB): Biomolecular Corona\'s Role Revealed',
          year: '2023',
          url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC10141840/',
          dateAdded: '2026-07-01',
          summary: 'Review. Examines how micro- and nanoplastics cross the blood–brain barrier and highlights the role of the biomolecular corona in mediating their neurotoxic effects.',
          categories: ['exposome', 'brain'],
        },
        {
          title: 'Induction of cortical on/off periods in awake mice fulfills sleep functions',
          ...
          summary: 'Research (in vivo). Nature Neuroscience. Demonstrates that artificially inducing cortical on/off periods in awake mice replicates the restorative functions of sleep.',
          categories: ['brain'],
        },
        {
          ...
          summary: 'Research. Nature. Identifies universal transcriptomic signatures of ageing and mortality conserved across mammalian species, revealing shared gene expression patterns that underpin biological ageing processes and longevity.',
          categories: ['longevity'],
        },
        {
          ...
          summary: 'Research. Demonstrates that extracellular vesicles derived from royal jelly accelerate wound healing by enhancing fibroblast migration and proliferation, promoting collagen synthesis, and modulating inflammatory responses.',
          categories: ['apitherapy', 'ev'],
        },
        {
          ...
          year: '2026',
          url: 'https://www.nature.com/articles/s43587-026-01150-x',
          dateAdded: '2026-08-17',
          summary: 'Research (human). Nature Aging. Demonstrates that exercise training in humans delays molecular aging signatures in skeletal muscle, preserves energy metabolism pathways, and enhances the transcriptional and metabolic response to acute exercise.',
          categories: ['exercise', 'longevity'],
        },
        {
          title: 'Muscle-Derived Small Extracellular Vesicles Regulate Bone Maintenance During Hibernation Through miRNA-Mediated Signaling',
          year: '2026',
        ...
        },
        {
          ...
          year: '2026',
          url: 'https://www.medrxiv.org/content/medrxiv/early/2026/08/12/2026.08.11.26360193.full.pdf',
          dateAdded: '2026-08-31',
          summary: 'Research (human). medRxiv preprint. Identifies miR-151a-5p in neuron-derived extracellular vesicles as a mediator of antidepressant treatment response, linking neuronal EV cargo to psychiatric drug efficacy.',
          categories: ['ev', 'brain', 'tsrna'],
        },
      ],
    },
    apitherapy: {
      ...
      items: [
        { title: 'Research Lab', description: 'Molecular Biology & Cellular Research' },
        {
          ...
          subItems: [
            ...
            { title: 'Brazilian Jiu-Jitsu', description: 'Grappling and ground-fighting martial art' },
    ...
    science: {
      ...
      literatureItems: [
        ...
        },
        {
          ...
          url: 'https://academic.oup.com/eurjpc/article/32/1/10/7758152',
          dateAdded: '2026-03-01',
          summary: 'Araştırma (gözlemsel). European Journal of Preventive Cardiology. Fiziksel aktivite hacmi, yoğunluğu, süresi ve parçalanmasının ABD\'li yetişkinlerde tüm nedenli ve kardiyovasküler ölüm riskiyle ilişkisini inceler.',
          categories: ['exercise', 'longevity'],
        },
        {
          title: 'MiRNAs shape mouse age-independent tissue adaptation to spaceflight via ECM and developmental pathways',
          ...
          url: 'https://www.nature.com/articles/s41467-026-68737-1',
          dateAdded: '2026-03-01',
          summary: 'Araştırma (in vivo). Nature Communications. Farelerde miRNA\'ların uzay uçuşuna bağlı çok organlu uyumları ECM, DNA hasarı ve gelişimsel yolaklar aracılığıyla yaştan bağımsız olarak düzenlediğini göstermektedir.',
          categories: ['tsrna', 'brain'],
        },
        {
          title: 'Extracellular vesicles as mediators of metabolomic changes in response to PET microplastics',
          ...
          url: 'https://www.sciencedirect.com/science/article/pii/S0269749125014204',
          dateAdded: '2026-03-04',
          summary: 'Araştırma. Environmental Pollution. PET mikroplastik maruziyetinin ekstraselüler vezikül aracılı sinyalizasyon yoluyla metabolomik profilleri nasıl değiştirdiğini araştırmaktadır.',
          categories: ['exposome', 'ev'],
        },
        {
          title: 'Poor Sleep Quality Is Associated With an Increased Risk of Running-Related Injuries: A Prospective Study of 339 Runners Over Six Months',
          ...
          url: 'https://pubmed.ncbi.nlm.nih.gov/41239840/',
          dateAdded: '2026-03-04',
          summary: 'Araştırma (prospektif). Scandinavian Journal of Medicine & Science in Sports. 339 koşucuyla yapılan altı aylık prospektif çalışmada düşük uyku kalitesinin koşuya bağlı yaralanma riskini artırdığını göstermektedir.',
          categories: ['exercise'],
        },
        {
          title: 'Altered sperm tsRNAs in aged male contribute to anxiety-like behavior in offspring',
          ...
          url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC8441364/#acel13466-sec-0009',
          dateAdded: '2026-03-04',
          summary: 'Araştırma (in vivo). Aging Cell. Yaşlı erkeklerdeki değişmiş sperm tsRNA\'larının yavru nesillerde anksiyete benzeri davranışa katkıda bulunduğunu göstermektedir.',
          categories: ['tsrna', 'brain'],
        },
        {
          title: 'Short-term diet intervention comprising of olive oil, vitamin D, and omega-3 fatty acids alters the small non-coding RNA (sncRNA) landscape of human sperm',
          ...
          url: 'https://www.nature.com/articles/s41598-024-83653-4',
          dateAdded: '2026-03-12',
          summary: 'Araştırma (insan). Scientific Reports. Zeytin yağı, D vitamini ve omega-3 yağ asitlerini içeren 6 haftalık beslenme müdahalesi insan sperminde tRF, miRNA ve piRNA ekspresyonunu değiştirerek sperm sncRNA\'larının paternal beslenmenin epigenetik aracıları olduğuna işaret etmektedir.',
          categories: ['nutrition', 'tsrna'],
        },
        {
          title: 'Young CSF restores oligodendrogenesis and memory in aged mice via Fgf17',
          ...
          url: 'https://www.nature.com/articles/s41586-022-04722-0',
          dateAdded: '2026-03-12',
          summary: 'Araştırma (in vivo). Nature. Yaşlı farelere genç serebrospinal sıvı infüzyonu oligodendrogenezi ve belleği geri kazandırır; yaşla birlikte azalan Fgf17\'yi temel gençleştirici faktör olarak tanımlar.',
          categories: ['brain', 'longevity'],
        },
        {
          title: 'Impact of a high-protein diet with and without strength training over 17 weeks on the plasma metabolome in older adults',
          ...
          url: 'https://doi.org/10.1093/ageing/afag010',
          dateAdded: '2026-07-08',
          summary: 'Araştırma (RKÇ). Age and Ageing. 17 haftalık yüksek proteinli diyetin, direnç antrenmanıyla veya antrenman olmadan, yaşlı bireylerin plazma metabolomu üzerindeki etkisini incelemektedir.',
          categories: ['nutrition', 'exercise', 'longevity'],
        },
        {
          title: 'Micro- and Nanoplastics Breach the Blood–Brain Barrier (BBB): Biomolecular Corona\'s Role Revealed',
          ...
          url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC10141840/',
          dateAdded: '2026-07-01',
          summary: 'Derleme. Mikro ve nanoplastiklerin kan-beyin bariyerini nasıl aştığını ve biyomoleküler koronanın bu geçişi nasıl kolaylaştırdığını incelemektedir.',
          categories: ['exposome', 'brain'],
        },
        {
          title: 'Induction of cortical on/off periods in awake mice fulfills sleep functions',
          ...
          url: 'https://www.nature.com/articles/s41593-026-02318-9',
          dateAdded: '2026-07-24',
          summary: 'Araştırma (in vivo). Nature Neuroscience. Uyanık farelerde kortikal açık/kapalı dönemlerin yapay olarak indüklenmesinin uykunun restoratif işlevlerini yerine getirdiğini göstermektedir.',
          categories: ['brain'],
        },
        {
          title: 'Universal transcriptomic hallmarks of mammalian ageing and mortality',
          ...
          url: 'https://www.nature.com/articles/s41586-026-10542-3',
          dateAdded: '2026-08-03',
          summary: 'Araştırma. Nature. Memelilerde yaşlanma ve mortaliteye özgü evrensel transkriptomik imzaları türler arasında korunmuş gen ekspresyon örüntüleriyle tanımlamakta; biyolojik yaşlanma ve longevity süreçlerine temel oluşturan mekanizmaları ortaya koymaktadır.',
          categories: ['longevity'],
        },
        {
          title: 'Royal jelly extracellular vesicles promote wound healing by modulating underlying cellular responses',
          ...
          url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC9989319/',
          dateAdded: '2026-08-10',
          summary: 'Araştırma. Arı sütünden elde edilen ekstraselüler vesiküllerin fibroblast göçünü ve çoğalmasını artırarak, kollajen sentezini destekleyerek ve inflamatuvar yanıtları düzenleyerek yara iyileşmesini hızlandırdığını ortaya koymaktadır.',
          categories: ['apitherapy', 'ev'],
        },
        {
          title: 'Delayed molecular aging, preservation of energy metabolism and enhanced exercise response in exercise-trained human muscle',
          ...
          url: 'https://www.nature.com/articles/s43587-026-01150-x',
          dateAdded: '2026-08-17',
          summary: 'Araştırma (insan). Nature Aging. İnsan iskelet kasında egzersiz antrenmanının moleküler yaşlanma imzalarını geciktirdiğini, enerji metabolizması yolaklarını koruduğunu ve akut egzersize verilen transkriptomik ve metabolik yanıtı güçlendirdiğini göstermektedir.',
          categories: ['exercise', 'longevity'],
        },
        {
          title: 'Muscle-Derived Small Extracellular Vesicles Regulate Bone Maintenance During Hibernation Through miRNA-Mediated Signaling',
        ...
        },
        {
          ...
          url: 'https://www.medrxiv.org/content/medrxiv/early/2026/08/12/2026.08.11.26360193.full.pdf',
          dateAdded: '2026-08-31',
          summary: 'Araştırma (insan). medRxiv preprint. Nöron kaynaklı ekstraselüler vesiküllerdeki miR-151a-5p\'nin antidepresan tedavi yanıtına aracılık ettiğini belirlemekte; nöronal EV içeriğini psikiyatrik ilaç etkinliğiyle ilişkilendirmektedir.',
          categories: ['ev', 'brain', 'tsrna'],
        },
      ],
    },
      ...
      items: [
        { title: 'Araştırma Laboratuvarı', description: 'Moleküler Biyoloji & Hücresel Araştırma' },
        {
          ...
          subItems: [
            ...
            { title: 'Brezilya Jiujitsusu', description: 'Güreş ve zemin dövüşü dövüş sanatı' },
