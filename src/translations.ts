    ...
    science: {
      ...
      literatureItems: [
        ...
        },
        {
          ...
          year: '2026',
          url: 'https://www.sciencedirect.com/science/article/pii/S000689932600291X',
          dateAdded: '2026-06-20',
          summary: 'Research. Analyzes the expression profile of tRNA-derived fragments (tRFs) in lipopolysaccharide (LPS)-activated microglia, revealing their regulatory roles in microglial activation and immune response modulation.',
          categories: ['tsrna', 'brain', 'ev'],
        },
      ],
    },
    apitherapy: {
    ...
    science: {
      ...
      literatureItems: [
        ...
        },
        {
          ...
          url: 'https://www.sciencedirect.com/science/article/pii/S000689932600291X',
          dateAdded: '2026-06-20',
          summary: 'Araştırma. Lipopolisakkarit (LPS) ile aktive edilen mikrogliada tRNA kaynaklı fragmanların (tRF) ekspresyon profilini analiz eden ve mikroglial aktivasyon ile bağışıklık yanıtının düzenlenmesindeki düzenleyici rollerini ortaya koyan çalışma.',
          categories: ['tsrna', 'brain', 'ev'],
        },
      ],
    },
