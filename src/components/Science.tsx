...
const categoryColors: Record<string, { bg: string; text: string; border: string; activeBg: string }> = {
  ...
  tsrna: { bg: 'bg-cyan-50', text: 'text-cyan-700', border: 'border-cyan-200', activeBg: 'bg-cyan-600' },
  exposome: { bg: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200', activeBg: 'bg-orange-500' },
  longevity: { bg: 'bg-indigo-50', text: 'text-indigo-700', border: 'border-indigo-200', activeBg: 'bg-indigo-600' },
  nutrition: { bg: 'bg-lime-50', text: 'text-lime-700', border: 'border-lime-200', activeBg: 'bg-lime-600' },
};
  ...
  const sections = [
    {
      ...
      content: [
        ...
        { title: 'ARIOZ, B.I., BINOKAY, L., KOCAKUSAK, H., KARAKÜLAH, G., GENC, S. (2026)', venue: 'Profiling tRNA-derived fragments in LPS-induced microglia and their influence on immune response. Brain Research', url: 'https://authors.elsevier.com/c/1nJOU_A2ZC0FZ' },
      ],
      type: 'publications',
    },
    {
      ...
      content: [
        ...
        { title: '1st Extracellular Vesicles Conference (TURSEV-24)', year: '2024', location: 'Ankara, Turkey', type: 'Poster', url: 'https://meetinghand.com/e/1-extracellular-vesicles-conference/#welcome-3069' },
